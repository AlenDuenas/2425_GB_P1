...
public class Companyies {
    ...
    private static String companyia() {
        ...
        String[] lineaCompanyia = new String[161];  // Adjust array size based on the file content
        try (BufferedReader br = new BufferedReader(new FileReader("companiascatalan.txt"))) {
            String temporal;
            int cont = 0;
